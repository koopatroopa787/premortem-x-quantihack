...
_SYNTHETIC_GRAPH = {
    ...
    "GIS":   ["supplier_wheat_01", "supplier_corn_01", "supplier_cacao_02"],
    ...
    "ENR":   ["supplier_zinc_01", "supplier_chemical_01"],
    "COTY":  ["supplier_glass_01", "supplier_alcohol_01"],
    "EL":    ["supplier_glass_01", "supplier_palm_01"],
    "CL":    ["supplier_chemical_01", "supplier_palm_01"],
    "RBGLY": ["supplier_chemical_01", "supplier_packaging_01"],
    "NWL":   ["supplier_plastic_01", "supplier_packaging_01"],
}
