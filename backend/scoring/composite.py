def compute_composite_score(signals):
    ...
    """
    weights = {
        "fda": 0.31,    # T1 - most credible
        "wiki": 0.25,      # T1 - quant novelty
        "fred": 0.19,    # T1 - macro context
        "adzuna": 0.15,    # T2 - talent signal
        "edgar": 0.10,     # T2 - legal signal
    }
